...
public class TestReportBuilder {
	...
	public void testJsoup() {
		try {
			byte[] encoded = Files.readAllBytes(Paths.get("/home/axelor/studio/studio-app/modules/axelor-studio/src/main/resources/css/studio.css"));
			String css = new String(encoded, "utf-8");
			
			String html = "<div><table class=\"table no-border\">"
			...
			html = "<html><head><style type=\"text/css\">" + css + "</style></head><body>" + html + "</body></html>";
			
			html = "<table class=\"table no-border\"><tbody><tr><td><table><tbody><tr><td><h4><u>Panel</u>"
